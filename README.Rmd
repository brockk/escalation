...
<!-- badges: start -->
[![Travis build status](https://app.travis-ci.org/brockk/escalation.svg?branch=master)](https://app.travis-ci.com/brockk/escalation)
[![Codecov test coverage](https://app.codecov.io/gh/brockk/escalation/branch/master/graph/badge.svg)](https://app.codecov.io/gh/brockk/escalation?branch=master)
[![cran
