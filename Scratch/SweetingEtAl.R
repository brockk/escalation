...
#' @importFrom dplyr tibble bind_rows reduce mutate
#' @export
#'
#' @examples
#' # TODO
stack_sims_vert <- function(sim_map, target_dose = NULL) {
  sim_map %>%
    imap(
      ~ {
...
#'
#' Normal approximation in deriavtion of confidence intervals of differences in
...
#' @references
#' # TODO
compare_sims <- function(sim_map, target_dose = NULL) {

  stacked_df <- stack_sims_vert(sim_map, target_dose)
