...
If a dose is excluded by this rule, it should not be recommended by model.
...
model <- get_tpi(num_doses = 5, target = 0.25, alpha = 0.005, beta = 0.005, 
...
Their example concerns a clinical trial of eight doses.
...
In really life, however, we would naturally run many thousands of iterations.
